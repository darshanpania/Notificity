...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        /**
         * MIGRATION 1 -> 2 Change in PrimaryKey for [NotificationEntity] The primary key is now
         * composed of [NotificationEntity.id] && [NotificationEntity.packageName] The
         * [NotificationEntity.id] is now set to the notificationId which was originally sent to the
         * NotificationManager
         */
        ...
        /**
         * MIGRATION 2 -> 3 Changed primary key from composite (id + packageName) to single
         * autogenerated id. Introduced notificationId column to hold old id.
         */
