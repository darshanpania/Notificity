 ...
 *
 * Provides helper utilities to identify group summary notifications that should be skipped
 * when processing notifications for tracking or display.
 */
object NotificationValidator {
    ...
    /**
     * Returns true if text matches common summary/count notification patterns.
     * These typically include messages like "3 new messages" or "You have 5 unread"
     */
